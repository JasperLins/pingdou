package cn.pixel.pingdou.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     *
     * 关联 cn.pixel.pingdou.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
