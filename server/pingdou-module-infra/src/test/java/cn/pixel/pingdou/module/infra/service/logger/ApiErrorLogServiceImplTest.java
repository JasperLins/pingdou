package cn.pixel.pingdou.module.infra.service.logger;
...
import cn.pixel.pingdou.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.pixel.pingdou.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.pixel.pingdou.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.pixel.pingdou.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.pixel.pingdou.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.pixel.pingdou.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("pingdou-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("pingdou-test");
