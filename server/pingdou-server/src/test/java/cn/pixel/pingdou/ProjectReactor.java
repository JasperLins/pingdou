...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.pixel.boot";
    private static final String ARTIFACT_ID = "pingdou";
    private static final String PACKAGE_NAME = "cn.pixel.pingdou";
    private static final String TITLE = "拼豆管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.pixel.boot";
        String artifactIdNew = "pingdou";
        String packageNameNew = "cn.pixel.pingdou";
        String titleNew = "拼豆管理系统";
