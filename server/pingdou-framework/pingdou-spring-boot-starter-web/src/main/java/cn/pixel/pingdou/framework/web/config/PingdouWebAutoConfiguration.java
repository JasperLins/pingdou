package cn.pixel.pingdou.framework.web.config;
...
import cn.pixel.pingdou.framework.web.core.filter.CacheRequestBodyFilter;
import cn.pixel.pingdou.framework.web.core.filter.DemoFilter;
import cn.pixel.pingdou.framework.web.core.handler.GlobalExceptionHandler;
import cn.pixel.pingdou.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class PingdouWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "pingdou.demo", havingValue = "true")
