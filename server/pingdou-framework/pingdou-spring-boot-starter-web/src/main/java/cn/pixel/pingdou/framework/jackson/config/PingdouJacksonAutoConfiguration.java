package cn.pixel.pingdou.framework.jackson.config;

import cn.pixel.pingdou.framework.common.util.json.JsonUtils;
import cn.pixel.pingdou.framework.common.util.json.databind.NumberSerializer;
import cn.pixel.pingdou.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import cn.pixel.pingdou.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class PingdouJacksonAutoConfiguration {
