...
import cn.pixel.pingdou.framework.tracer.core.aop.BizTraceAspect;
import cn.pixel.pingdou.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "pingdou.tracer", value = "enable", matchIfMissing = true)
public class PingdouTracerAutoConfiguration {
