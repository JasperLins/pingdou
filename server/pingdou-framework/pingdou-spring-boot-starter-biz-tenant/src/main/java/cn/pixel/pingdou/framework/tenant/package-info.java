 ...
 *      1）Spring Async：
 *          {@link cn.pixel.pingdou.framework.quartz.config.PingdouAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 PingdouSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package cn.pixel.pingdou.framework.tenant;
