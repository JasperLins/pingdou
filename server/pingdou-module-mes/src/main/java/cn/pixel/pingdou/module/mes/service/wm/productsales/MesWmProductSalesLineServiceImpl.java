...
import cn.pixel.pingdou.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO;
import cn.pixel.pingdou.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLineSaveReqVO;
...
import cn.pixel.pingdou.module.mes.dal.mysql.wm.productsales.MesWmProductSalesLineMapper;
import cn.pixel.pingdou.module.mes.enums.qc.MesQcCheckResultEnum;
...
import cn.pixel.pingdou.module.mes.dal.dataobject.wm.salesnotice.MesWmSalesNoticeLineDO;
import cn.pixel.pingdou.module.mes.service.wm.salesnotice.MesWmSalesNoticeLineService;
...
public class MesWmProductSalesLineServiceImpl implements MesWmProductSalesLineService {
    ...
    @Override
    public cn.pixel.pingdou.framework.common.pojo.PageResult<MesWmProductSalesLineDO> getProductSalesLinePage(
        ...
        if (pageReqVO.getSalesId() == null && pageReqVO.getClientId() != null) {
            ...
            if (CollUtil.isEmpty(salesList)) {
                return cn.pixel.pingdou.framework.common.pojo.PageResult.empty();
            }
