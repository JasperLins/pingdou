...
import cn.pixel.pingdou.module.mes.controller.admin.pro.task.vo.MesProTaskIssuePageReqVO;
import cn.pixel.pingdou.module.mes.controller.admin.pro.task.vo.MesProTaskIssueRespVO;
import cn.pixel.pingdou.module.mes.controller.admin.pro.task.vo.MesProTaskIssueSaveReqVO;
...
import cn.pixel.pingdou.module.mes.dal.dataobject.pro.task.MesProTaskIssueDO;
...
import cn.pixel.pingdou.module.mes.service.pro.task.MesProTaskIssueService;
...
public class MesProTaskIssueController {
    ...
    private List<MesProTaskIssueRespVO> buildIssueRespVOList(List<MesProTaskIssueDO> list) {
        ...
        // 拼接 VO
        return cn.pixel.pingdou.framework.common.util.collection.CollectionUtils.convertList(list, issue -> {
