package cn.pixel.pingdou.module.iot.job.device;
...
import cn.pixel.pingdou.module.iot.framework.iot.config.PingdouIotProperties;
...
public class IotDeviceOfflineCheckJob implements JobHandler {
    ...
    @Resource
    private PingdouIotProperties iotProperties;
