package cn.pixel.pingdou.module.iot.service.alert;
...
import cn.pixel.pingdou.module.iot.controller.admin.alert.vo.config.IotAlertConfigPageReqVO;
import cn.pixel.pingdou.module.iot.controller.admin.alert.vo.config.IotAlertConfigSaveReqVO;
import cn.pixel.pingdou.module.iot.dal.dataobject.alert.IotAlertConfigDO;
import cn.pixel.pingdou.module.iot.dal.mysql.alert.IotAlertConfigMapper;
import cn.pixel.pingdou.module.iot.enums.alert.IotAlertReceiveTypeEnum;
import cn.pixel.pingdou.module.iot.service.rule.scene.IotSceneRuleService;
...
import static cn.pixel.pingdou.module.iot.enums.ErrorCodeConstants.ALERT_CONFIG_MAIL_TEMPLATE_REQUIRED;
import static cn.pixel.pingdou.module.iot.enums.ErrorCodeConstants.ALERT_CONFIG_NOT_EXISTS;
import static cn.pixel.pingdou.module.iot.enums.ErrorCodeConstants.ALERT_CONFIG_NOTIFY_TEMPLATE_REQUIRED;
import static cn.pixel.pingdou.module.iot.enums.ErrorCodeConstants.ALERT_CONFIG_SMS_TEMPLATE_REQUIRED;
