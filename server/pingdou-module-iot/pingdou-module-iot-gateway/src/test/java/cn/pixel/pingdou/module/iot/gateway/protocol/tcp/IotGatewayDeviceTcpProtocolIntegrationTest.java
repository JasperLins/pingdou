...
import cn.pixel.pingdou.module.iot.core.topic.topo.IotDeviceTopoGetReqDTO;
import cn.pixel.pingdou.module.iot.core.util.IotDeviceAuthUtils;
import cn.pixel.pingdou.module.iot.gateway.protocol.tcp.codec.IotTcpCodecTypeEnum;
...
import cn.pixel.pingdou.module.iot.gateway.serialize.json.IotJsonSerializer;
 ...
 * <p>使用步骤：
 * <ol>
 *     <li>启动 pingdou-module-iot-gateway 服务（TCP 端口 8091）</li>
 *     <li>运行以下测试方法：
 *         <ul>
