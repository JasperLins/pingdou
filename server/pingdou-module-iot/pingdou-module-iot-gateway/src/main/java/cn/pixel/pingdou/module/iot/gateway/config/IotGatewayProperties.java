package cn.pixel.pingdou.module.iot.gateway.config;

import cn.pixel.pingdou.module.iot.core.enums.IotProtocolTypeEnum;
import cn.pixel.pingdou.module.iot.gateway.protocol.coap.IotCoapConfig;
import cn.pixel.pingdou.module.iot.gateway.protocol.emqx.IotEmqxConfig;
import cn.pixel.pingdou.module.iot.gateway.protocol.http.IotHttpConfig;
import cn.pixel.pingdou.module.iot.gateway.protocol.modbus.tcpclient.IotModbusTcpClientConfig;
import cn.pixel.pingdou.module.iot.gateway.protocol.modbus.tcpserver.IotModbusTcpServerConfig;
import cn.pixel.pingdou.module.iot.gateway.protocol.mqtt.IotMqttConfig;
import cn.pixel.pingdou.module.iot.gateway.protocol.tcp.IotTcpConfig;
import cn.pixel.pingdou.module.iot.gateway.protocol.udp.IotUdpConfig;
import cn.pixel.pingdou.module.iot.gateway.protocol.websocket.IotWebSocketConfig;
...
@ConfigurationProperties(prefix = "pingdou.iot.gateway")
@Validated
@Data
public class IotGatewayProperties {
    ...
    public static class ProtocolProperties {
         ...
         * 协议类型
         *
         * @see cn.pixel.pingdou.module.iot.core.enums.IotProtocolTypeEnum
         */
         ...
         * 序列化类型（可选）
         *
         * @see cn.pixel.pingdou.module.iot.core.enums.IotSerializeTypeEnum
         *
         * 为什么是可选的呢？
