package cn.pixel.pingdou.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import cn.pixel.pingdou.framework.common.exception.enums.GlobalErrorCodeConstants;
import cn.pixel.pingdou.framework.common.pojo.CommonResult;
import cn.pixel.pingdou.framework.common.util.json.JsonUtils;
import cn.pixel.pingdou.module.iot.core.biz.IotDeviceCommonApi;
import cn.pixel.pingdou.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import cn.pixel.pingdou.module.iot.core.biz.dto.IotDeviceRespDTO;
import cn.pixel.pingdou.module.iot.core.biz.dto.IotModbusDeviceConfigRespDTO;
import cn.pixel.pingdou.module.iot.core.biz.dto.IotModbusPointRespDTO;
import cn.pixel.pingdou.module.iot.core.enums.IotDeviceMessageMethodEnum;
import cn.pixel.pingdou.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
import cn.pixel.pingdou.module.iot.core.mq.message.IotDeviceMessage;
import cn.pixel.pingdou.module.iot.core.topic.IotDeviceIdentity;
import cn.pixel.pingdou.module.iot.core.util.IotDeviceAuthUtils;
import cn.pixel.pingdou.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import cn.pixel.pingdou.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import cn.pixel.pingdou.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import cn.pixel.pingdou.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import cn.pixel.pingdou.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import cn.pixel.pingdou.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import cn.pixel.pingdou.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import cn.pixel.pingdou.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import cn.pixel.pingdou.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import cn.pixel.pingdou.module.iot.gateway.service.device.IotDeviceService;
import cn.pixel.pingdou.module.iot.gateway.service.device.message.IotDeviceMessageService;
import io.vertx.core.net.NetSocket;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static cn.pixel.pingdou.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static cn.pixel.pingdou.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static cn.pixel.pingdou.framework.common.exception.util.ServiceExceptionUtil.invalidParamException;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link cn.pixel.pingdou.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
