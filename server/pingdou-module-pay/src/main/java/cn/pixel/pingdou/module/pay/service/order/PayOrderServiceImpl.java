...
import cn.pixel.pingdou.module.pay.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
...
import cn.pixel.pingdou.module.pay.convert.order.PayOrderConvert;
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://gitee.com/zhijiantianya/pingdou-cloud/issues/I8SM9H 场景
