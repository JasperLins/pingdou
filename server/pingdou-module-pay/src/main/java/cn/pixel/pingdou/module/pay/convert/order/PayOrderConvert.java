package cn.pixel.pingdou.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, cn.pixel.pingdou.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
