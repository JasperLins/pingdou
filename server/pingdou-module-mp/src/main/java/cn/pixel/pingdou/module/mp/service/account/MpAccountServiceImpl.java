package cn.pixel.pingdou.module.mp.service.account;
...
import cn.pixel.pingdou.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import cn.pixel.pingdou.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import cn.pixel.pingdou.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import cn.pixel.pingdou.module.mp.convert.account.MpAccountConvert;
import cn.pixel.pingdou.module.mp.dal.dataobject.account.MpAccountDO;
import cn.pixel.pingdou.module.mp.dal.mysql.account.MpAccountMapper;
import cn.pixel.pingdou.module.mp.enums.ErrorCodeConstants;
import cn.pixel.pingdou.module.mp.framework.mp.core.MpServiceFactory;
...
import static cn.pixel.pingdou.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 pingdou-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
