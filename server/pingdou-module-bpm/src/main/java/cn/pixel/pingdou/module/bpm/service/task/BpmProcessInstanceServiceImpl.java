package cn.pixel.pingdou.module.bpm.service.task;
...
import cn.pixel.pingdou.framework.common.util.date.DateUtils;
...
import cn.pixel.pingdou.framework.datapermission.core.annotation.DataPermission;
import cn.pixel.pingdou.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import cn.pixel.pingdou.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import cn.pixel.pingdou.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import cn.pixel.pingdou.module.bpm.controller.admin.task.vo.instance.*;
import cn.pixel.pingdou.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import cn.pixel.pingdou.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import cn.pixel.pingdou.module.bpm.convert.task.BpmProcessInstanceConvert;
import cn.pixel.pingdou.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.pixel.pingdou.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import cn.pixel.pingdou.module.bpm.enums.ErrorCodeConstants;
import cn.pixel.pingdou.module.bpm.enums.definition.BpmModelTypeEnum;
import cn.pixel.pingdou.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import cn.pixel.pingdou.module.bpm.enums.task.BpmAttachmentTypeEnum;
import cn.pixel.pingdou.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import cn.pixel.pingdou.module.bpm.enums.task.BpmReasonEnum;
import cn.pixel.pingdou.module.bpm.enums.task.BpmTaskStatusEnum;
import cn.pixel.pingdou.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import cn.pixel.pingdou.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import cn.pixel.pingdou.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import cn.pixel.pingdou.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import cn.pixel.pingdou.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import cn.pixel.pingdou.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import cn.pixel.pingdou.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import cn.pixel.pingdou.module.bpm.framework.flowable.core.util.FlowableUtils;
import cn.pixel.pingdou.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import cn.pixel.pingdou.module.bpm.service.definition.BpmProcessDefinitionService;
import cn.pixel.pingdou.module.bpm.service.message.BpmMessageService;
...
import static cn.pixel.pingdou.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static cn.pixel.pingdou.module.bpm.enums.ErrorCodeConstants.*;
import static cn.pixel.pingdou.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static cn.pixel.pingdou.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/pingdou-cloud/issues/ID1UYA
