package cn.pixel.pingdou.module.crm.controller.admin.product.vo.product;
...
public class CrmProductRespVO implements VO {
    ...
    @Trans(type = TransType.SIMPLE, targetClassName = "cn.pixel.pingdou.module.system.dal.dataobject.user.AdminUserDO",
