package cn.pixel.pingdou.module.system.service.social;
...
import cn.pixel.pingdou.framework.common.util.cache.CacheUtils;
import cn.pixel.pingdou.framework.common.util.http.HttpUtils;
import cn.pixel.pingdou.framework.common.util.object.BeanUtils;
import cn.pixel.pingdou.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.pixel.pingdou.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import cn.pixel.pingdou.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.pixel.pingdou.module.system.dal.dataobject.social.SocialClientDO;
import cn.pixel.pingdou.module.system.dal.mysql.social.SocialClientMapper;
import cn.pixel.pingdou.module.system.dal.redis.RedisKeyConstants;
import cn.pixel.pingdou.module.system.enums.social.SocialTypeEnum;
import cn.pixel.pingdou.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.pixel.pingdou.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.pixel.pingdou.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${pingdou.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${pingdou.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/pingdou-cloud/pulls/230
