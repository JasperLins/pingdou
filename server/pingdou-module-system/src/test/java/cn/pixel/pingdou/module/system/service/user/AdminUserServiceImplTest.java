package cn.pixel.pingdou.module.system.service.user;
...
import cn.pixel.pingdou.module.infra.api.config.ConfigApi;
import cn.pixel.pingdou.module.infra.api.file.FileApi;
import cn.pixel.pingdou.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.pixel.pingdou.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.pixel.pingdou.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.pixel.pingdou.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.pixel.pingdou.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.pixel.pingdou.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import cn.pixel.pingdou.module.system.dal.dataobject.dept.DeptDO;
import cn.pixel.pingdou.module.system.dal.dataobject.dept.PostDO;
import cn.pixel.pingdou.module.system.dal.dataobject.dept.UserPostDO;
import cn.pixel.pingdou.module.system.dal.dataobject.tenant.TenantDO;
import cn.pixel.pingdou.module.system.dal.dataobject.user.AdminUserDO;
import cn.pixel.pingdou.module.system.dal.mysql.dept.UserPostMapper;
import cn.pixel.pingdou.module.system.dal.mysql.user.AdminUserMapper;
import cn.pixel.pingdou.module.system.enums.common.SexEnum;
import cn.pixel.pingdou.module.system.mq.producer.user.AdminUserProducer;
import cn.pixel.pingdou.module.system.service.dept.DeptService;
import cn.pixel.pingdou.module.system.service.dept.PostService;
import cn.pixel.pingdou.module.system.service.oauth2.OAuth2TokenService;
import cn.pixel.pingdou.module.system.service.permission.PermissionService;
import cn.pixel.pingdou.module.system.service.tenant.TenantService;
...
import static cn.pixel.pingdou.framework.common.util.collection.SetUtils.asSet;
import static cn.pixel.pingdou.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.pixel.pingdou.framework.common.util.date.LocalDateTimeUtils.buildTime;
...
import static cn.pixel.pingdou.module.system.enums.ErrorCodeConstants.*;
import static cn.pixel.pingdou.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("pingdouyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("pingdouyuanma");
        ...
        assertEquals("pingdouyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("pingdouyuanma"))).thenReturn("java");
