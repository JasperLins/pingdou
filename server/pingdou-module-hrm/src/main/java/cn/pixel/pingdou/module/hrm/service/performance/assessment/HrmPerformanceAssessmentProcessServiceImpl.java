package cn.pixel.pingdou.module.hrm.service.performance.assessment;

import cn.pixel.pingdou.module.hrm.service.performance.plan.HrmPerformancePlanService;
...
import cn.pixel.pingdou.module.hrm.controller.admin.portal.performance.vo.process.HrmPortalPerformanceAppealReqVO;
import cn.pixel.pingdou.module.hrm.controller.admin.portal.performance.vo.process.HrmPortalPerformanceConfirmReqVO;
import cn.pixel.pingdou.module.hrm.controller.admin.portal.performance.vo.process.HrmPortalPerformanceHandleStageReqVO;
import cn.pixel.pingdou.module.hrm.controller.admin.portal.performance.vo.process.HrmPortalPerformanceProcessRespVO;
import cn.pixel.pingdou.module.hrm.controller.admin.portal.performance.vo.task.HrmPortalPerformanceTaskPageReqVO;
import cn.pixel.pingdou.module.hrm.dal.dataobject.employee.info.HrmEmployeeDO;
import cn.pixel.pingdou.module.hrm.dal.dataobject.performance.assessment.HrmPerformanceAssessmentAppealRecordDO;
import cn.pixel.pingdou.module.hrm.dal.dataobject.performance.assessment.HrmPerformanceAssessmentDO;
import cn.pixel.pingdou.module.hrm.dal.dataobject.performance.assessment.HrmPerformanceAssessmentStageDO;
import cn.pixel.pingdou.module.hrm.dal.dataobject.performance.plan.HrmPerformancePlanDO;
import cn.pixel.pingdou.module.hrm.dal.dataobject.performance.plan.HrmPerformancePlanDO.HandlerStage;
import cn.pixel.pingdou.module.hrm.dal.dataobject.performance.plan.HrmPerformancePlanDO.ReviewStage;
import cn.pixel.pingdou.module.hrm.dal.mysql.performance.assessment.HrmPerformanceAssessmentAppealRecordMapper;
import cn.pixel.pingdou.module.hrm.dal.mysql.performance.assessment.HrmPerformanceAssessmentMapper;
import cn.pixel.pingdou.module.hrm.dal.mysql.performance.assessment.HrmPerformanceAssessmentQuotaMapper;
import cn.pixel.pingdou.module.hrm.dal.mysql.performance.assessment.HrmPerformanceAssessmentQuotaScoreMapper;
import cn.pixel.pingdou.module.hrm.dal.mysql.performance.assessment.HrmPerformanceAssessmentStageMapper;
import cn.pixel.pingdou.module.hrm.enums.MessageTemplateConstants;
import cn.pixel.pingdou.module.hrm.enums.performance.assessment.HrmPerformanceAppealStatusEnum;
import cn.pixel.pingdou.module.hrm.enums.performance.assessment.HrmPerformanceAppealRecordStatusEnum;
import cn.pixel.pingdou.module.hrm.enums.performance.assessment.HrmPerformanceAppealTimeoutActionEnum;
import cn.pixel.pingdou.module.hrm.enums.performance.assessment.HrmPerformanceAssessmentActionTypeEnum;
import cn.pixel.pingdou.module.hrm.enums.performance.assessment.HrmPerformanceAssessmentProcessStatusEnum;
import cn.pixel.pingdou.module.hrm.enums.performance.assessment.HrmPerformanceAssessmentStageStatusEnum;
import cn.pixel.pingdou.module.hrm.enums.performance.assessment.HrmPerformanceConfirmationResultEnum;
import cn.pixel.pingdou.module.hrm.enums.performance.plan.HrmPerformancePlanOperationTypeEnum;
import cn.pixel.pingdou.module.hrm.enums.performance.plan.HrmPerformancePlanStatusEnum;
import cn.pixel.pingdou.module.hrm.enums.performance.plan.HrmPerformanceQuotaSettingTypeEnum;
import cn.pixel.pingdou.module.hrm.enums.performance.plan.HrmPerformanceRaterTypeEnum;
import cn.pixel.pingdou.module.hrm.enums.performance.assessment.HrmPerformanceResultAuditStatusEnum;
import cn.pixel.pingdou.module.hrm.enums.performance.plan.HrmPerformanceStageTypeEnum;
...
import cn.pixel.pingdou.module.system.api.dept.dto.DeptRespDTO;
...
import static cn.pixel.pingdou.framework.common.util.collection.CollectionUtils.convertSet;
import static cn.pixel.pingdou.framework.common.util.collection.CollectionUtils.filterList;
import static cn.pixel.pingdou.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_ASSESSMENT_NOT_EXISTS;
import static cn.pixel.pingdou.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_DATA_ILLEGAL;
import static cn.pixel.pingdou.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_PROCESS_CONFIG_INVALID;
import static cn.pixel.pingdou.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_PROCESS_RUNNING_CANNOT_MODIFY;
import static cn.pixel.pingdou.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_REVIEW_STAGE_CONFIG_INVALID;
import static cn.pixel.pingdou.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_REVIEW_STAGE_NOT_EXISTS;
import static cn.pixel.pingdou.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_STAGE_ACTION_INVALID;
import static cn.pixel.pingdou.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_STAGE_HANDLER_USER_NOT_BOUND;
import static cn.pixel.pingdou.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_STAGE_NO_PERMISSION;
import static cn.pixel.pingdou.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_TARGET_CONFIRM_CONFIG_INVALID;
import static cn.pixel.pingdou.module.hrm.enums.ErrorCodeConstants.PERFORMANCE_TARGET_CONFIRM_NO_PERMISSION;
import static cn.pixel.pingdou.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_APPEAL_SUB_TYPE;
import static cn.pixel.pingdou.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_APPEAL_SUCCESS;
import static cn.pixel.pingdou.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_APPEAL_HANDLE_SUB_TYPE;
import static cn.pixel.pingdou.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_APPEAL_HANDLE_SUCCESS;
import static cn.pixel.pingdou.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_APPEAL_TIMEOUT_HANDLE_SUB_TYPE;
import static cn.pixel.pingdou.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_APPEAL_TIMEOUT_HANDLE_SUCCESS;
import static cn.pixel.pingdou.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_CONFIRM_RESULT_SUB_TYPE;
import static cn.pixel.pingdou.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_CONFIRM_RESULT_SUCCESS;
import static cn.pixel.pingdou.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_CONFIRM_TARGET_SUB_TYPE;
import static cn.pixel.pingdou.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_CONFIRM_TARGET_SUCCESS;
import static cn.pixel.pingdou.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_RESULT_AUDIT_SUB_TYPE;
import static cn.pixel.pingdou.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_RESULT_AUDIT_SUCCESS;
import static cn.pixel.pingdou.module.hrm.enums.LogRecordConstants.HRM_PERFORMANCE_TYPE;
