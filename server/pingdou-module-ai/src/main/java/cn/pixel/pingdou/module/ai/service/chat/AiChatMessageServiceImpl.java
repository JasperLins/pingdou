package cn.pixel.pingdou.module.ai.service.chat;
...
import cn.pixel.pingdou.framework.tenant.core.util.TenantUtils;
import cn.pixel.pingdou.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import cn.pixel.pingdou.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import cn.pixel.pingdou.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import cn.pixel.pingdou.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import cn.pixel.pingdou.module.ai.dal.dataobject.chat.AiChatConversationDO;
import cn.pixel.pingdou.module.ai.dal.dataobject.chat.AiChatMessageDO;
import cn.pixel.pingdou.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import cn.pixel.pingdou.module.ai.dal.dataobject.model.AiChatRoleDO;
import cn.pixel.pingdou.module.ai.dal.dataobject.model.AiModelDO;
import cn.pixel.pingdou.module.ai.dal.dataobject.model.AiToolDO;
import cn.pixel.pingdou.module.ai.dal.mysql.chat.AiChatMessageMapper;
import cn.pixel.pingdou.module.ai.enums.ErrorCodeConstants;
import cn.pixel.pingdou.module.ai.enums.model.AiPlatformEnum;
import cn.pixel.pingdou.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import cn.pixel.pingdou.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import cn.pixel.pingdou.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import cn.pixel.pingdou.module.ai.service.knowledge.AiKnowledgeDocumentService;
import cn.pixel.pingdou.module.ai.service.knowledge.AiKnowledgeSegmentService;
import cn.pixel.pingdou.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import cn.pixel.pingdou.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import cn.pixel.pingdou.module.ai.service.model.AiChatRoleService;
import cn.pixel.pingdou.module.ai.service.model.AiModelService;
import cn.pixel.pingdou.module.ai.service.model.AiToolService;
import cn.pixel.pingdou.module.ai.util.AiUtils;
import cn.pixel.pingdou.module.ai.util.FileTypeUtils;
...
import static cn.pixel.pingdou.framework.common.pojo.CommonResult.error;
...
import static cn.pixel.pingdou.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static cn.pixel.pingdou.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 pingdou.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 pingdou.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
