package cn.pixel.pingdou.module.ai.framework.ai.core.model;
...
import cn.pixel.pingdou.framework.common.util.spring.SpringUtils;
import cn.pixel.pingdou.module.ai.enums.model.AiPlatformEnum;
import cn.pixel.pingdou.module.ai.framework.ai.config.AiAutoConfiguration;
import cn.pixel.pingdou.module.ai.framework.ai.config.PingdouAiProperties;
...
import cn.pixel.pingdou.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.pixel.pingdou.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String rawApiKey, String rawUrl) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            PingdouAiProperties.Midjourney properties = SpringUtil.getBean(PingdouAiProperties.class)
                    .getMidjourney();
    ...
    private ChatModel buildYiYanChatModel(String apiKey) {
        PingdouAiProperties.YiYan properties = new PingdouAiProperties.YiYan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(PingdouAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        PingdouAiProperties.DouBao properties = new PingdouAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(PingdouAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        PingdouAiProperties.HunYuan properties = new PingdouAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(PingdouAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        PingdouAiProperties.SiliconFlow properties = new PingdouAiProperties.SiliconFlow()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildSiliconFlowChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#zhiPuChatClient(PingdouAiProperties)}
     */
    private ZhiPuChatModel buildZhiPuChatModel(String apiKey, String url) {
        PingdouAiProperties.ZhiPu properties = new PingdouAiProperties.ZhiPu()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildZhiPuChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#miniMaxChatClient(PingdouAiProperties)}
     */
    private MiniMaxChatModel buildMiniMaxChatModel(String apiKey, String url) {
        PingdouAiProperties.MiniMax properties = new PingdouAiProperties.MiniMax()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildMiniMaxChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#moonshotChatClient(PingdouAiProperties)}
     */
    private MoonshotChatModel buildMoonshotChatModel(String apiKey, String url) {
        PingdouAiProperties.Moonshot properties = new PingdouAiProperties.Moonshot()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildMoonshotChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#stepFunChatClient(PingdouAiProperties)}
     */
    private StepFunChatModel buildStepFunChatModel(String apiKey, String url) {
        PingdouAiProperties.StepFun properties = new PingdouAiProperties.StepFun()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildStepFunChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(PingdouAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String apiKey) {
        PingdouAiProperties.XingHuo properties = new PingdouAiProperties.XingHuo()
                .setApiKey(apiKey).setModel(XingHuoChatModel.MODEL_DEFAULT);
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(PingdouAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        PingdouAiProperties.BaiChuan properties = new PingdouAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(PingdouAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        PingdouAiProperties.Gemini properties = SpringUtil.getBean(PingdouAiProperties.class)
    ...
    private GrokChatModel buildGrokChatModel(String apiKey, String url) {
        PingdouAiProperties.Grok properties = new PingdouAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
