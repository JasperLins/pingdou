...
import cn.pixel.pingdou.framework.common.util.string.StrUtils;
import cn.pixel.pingdou.framework.dict.core.DictFrameworkUtils;
...
import cn.pixel.pingdou.module.member.api.user.dto.MemberUserRespDTO;
import cn.pixel.pingdou.module.pay.api.order.dto.PayOrderCreateReqDTO;
import cn.pixel.pingdou.module.pay.enums.DictTypeConstants;
import cn.pixel.pingdou.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import cn.pixel.pingdou.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import cn.pixel.pingdou.module.product.api.sku.dto.ProductSkuRespDTO;
import cn.pixel.pingdou.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import cn.pixel.pingdou.module.product.api.spu.dto.ProductSpuRespDTO;
import cn.pixel.pingdou.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import cn.pixel.pingdou.module.trade.api.order.dto.TradeOrderRespDTO;
import cn.pixel.pingdou.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import cn.pixel.pingdou.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import cn.pixel.pingdou.module.trade.controller.admin.order.vo.*;
import cn.pixel.pingdou.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import cn.pixel.pingdou.module.trade.controller.app.order.vo.*;
import cn.pixel.pingdou.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import cn.pixel.pingdou.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import cn.pixel.pingdou.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static cn.pixel.pingdou.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/pingdoucode/pingdou-mall-uniapp/issues/ICY7SJ
