package cn.pixel.pingdou.module.promotion.service.banner;

import cn.pixel.pingdou.framework.common.pojo.PageResult;
import cn.pixel.pingdou.module.promotion.controller.admin.banner.vo.BannerCreateReqVO;
import cn.pixel.pingdou.module.promotion.controller.admin.banner.vo.BannerPageReqVO;
import cn.pixel.pingdou.module.promotion.controller.admin.banner.vo.BannerUpdateReqVO;
import cn.pixel.pingdou.module.promotion.convert.banner.BannerConvert;
import cn.pixel.pingdou.module.promotion.dal.dataobject.banner.BannerDO;
import cn.pixel.pingdou.module.promotion.dal.mysql.banner.BannerMapper;
...
import static cn.pixel.pingdou.module.promotion.enums.ErrorCodeConstants.BANNER_NOT_EXISTS;
